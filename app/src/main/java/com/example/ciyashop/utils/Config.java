...
public class Config {
    ...
    public static final boolean IS_LOGIN_SHOW = false;       // set false to disable login screen before start application
    public static final boolean IS_INFINITE_LAYOUT = false;  // set false to set Default Home Layout
    ...
    public static boolean SHIMMER_VIEW = false; //set true when you want to disable progressbar and active shimmer view
