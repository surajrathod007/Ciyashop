...
package com.example.ciyashop.customview.libphonenumber.internal;


import com.example.ciyashop.customview.libphonenumber.Phonemetadata;
...
public final class RegexBasedMatcher implements MatcherApi {
    ...
    // @Override
    public boolean matchNationalNumber(CharSequence number, Phonemetadata.PhoneNumberDesc numberDesc,
