...
public final class Phonemetadata {
    ...
    public static class NumberFormat implements Externalizable {
        ...
        private final java.util.List<String> leadingDigitsPattern_ = new java.util.ArrayList<String>();
    ...
    public static class PhoneNumberDesc implements Externalizable {
        ...
        private final java.util.List<Integer> possibleLength_ = new java.util.ArrayList<>();
        ...
        private final java.util.List<Integer> possibleLengthLocalOnly_ = new java.util.ArrayList<>();
    ...
    public static class PhoneMetadata implements Externalizable {
        ...
        private final java.util.List<NumberFormat> numberFormat_ = new java.util.ArrayList<>();
        ...
        private final java.util.List<NumberFormat> intlNumberFormat_ =
    ...
    public static class PhoneMetadataCollection implements Externalizable {
        ...
        private final java.util.List<PhoneMetadata> metadata_ = new java.util.ArrayList<>();
