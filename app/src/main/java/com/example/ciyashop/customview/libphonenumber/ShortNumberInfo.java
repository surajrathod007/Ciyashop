...
public class ShortNumberInfo {
     ...
     * being dialed from.
     */
    private boolean regionDialingFromMatchesNumber(Phonenumber.PhoneNumber number,
     ...
     * #isPossibleShortNumberForRegion(Phonenumber.PhoneNumber, String)} for details.
     *
     * @param number the short number to check
     * @return whether the number is a possible short number
     */
     ...
     * the number is actually in use, which is impossible to tell by just looking at the number
     * itself. See {@link #isValidShortNumberForRegion(Phonenumber.PhoneNumber, String)} for details.
     *
     * @param number the short number for which we want to test the validity
     * @return whether the short number matches a valid pattern
     */
    ...
    public ShortNumberCost getExpectedCostForRegion(Phonenumber.PhoneNumber number, String regionDialingFrom) {
        ...
        Phonemetadata.PhoneMetadata phoneMetadata = MetadataManager.getShortNumberMetadataForRegion(
                regionDialingFrom);
        if (phoneMetadata == null) {
            return ShortNumberCost.UNKNOWN_COST;
        }
     ...
     * same as {@link #getExpectedCostForRegion(Phonenumber.PhoneNumber, String)}. However, if the country
     ...
     * {@link #getExpectedCostForRegion(Phonenumber.PhoneNumber, String)} instead.
     *
     * @param number the short number for which we want to know the expected cost category
    ...
    // valid is returned.
    private String getRegionCodeForShortNumberFromRegionList(Phonenumber.PhoneNumber number,
