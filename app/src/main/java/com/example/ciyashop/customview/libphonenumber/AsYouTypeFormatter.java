...
public class AsYouTypeFormatter {
    ...
    private final StringBuilder formattingTemplate = new StringBuilder();
    ...
    private final StringBuilder accruedInputWithoutFormatting = new StringBuilder();
    ...
    // code, and/or NDD, etc.
    private final StringBuilder prefixBeforeNationalNumber = new StringBuilder();
    ...
    private final StringBuilder nationalNumber = new StringBuilder();
    private final List<Phonemetadata.NumberFormat> possibleFormats = new ArrayList<>();

    // A cache for frequently used country-specific regular expressions.
    private final RegexCache regexCache = new RegexCache(64);
