package com.example.ciyashop.customview.contrycodepicker;
...
import com.example.ciyashop.customview.libphonenumber.NumberParseException;
import com.example.ciyashop.customview.libphonenumber.PhoneNumberUtil;
import com.example.ciyashop.customview.libphonenumber.Phonenumber;
...
public class CountryCodePicker extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        mCountryCodeHolderClickListener = v -> {
            if (isClickable()) {
