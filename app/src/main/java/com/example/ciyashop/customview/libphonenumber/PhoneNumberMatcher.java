...
final class PhoneNumberMatcher implements Iterator<PhoneNumberMatch> {
    ...
    private PhoneNumberMatch parseAndVerify(CharSequence candidate, int offset) {
        try {
            ...
            Phonenumber.PhoneNumber number = phoneUtil.parseAndKeepRawInput(candidate, preferredRegion);
    ...
    interface NumberGroupingChecker {
         ...
         */
        boolean checkGroups(PhoneNumberUtil util, Phonenumber.PhoneNumber number,
    ...
    boolean checkNumberGroupingIsValid(
            Phonenumber.PhoneNumber number, CharSequence candidate, PhoneNumberUtil util,
        ...
        Phonemetadata.PhoneMetadata alternateFormats =
    ...
    static boolean containsMoreThanOneSlashInNationalNumber(Phonenumber.PhoneNumber number, String candidate) {
        ...
        boolean candidateHasCountryCode =
                (number.getCountryCodeSource() == Phonenumber.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITH_PLUS_SIGN
                        || number.getCountryCodeSource() == Phonenumber.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITHOUT_PLUS_SIGN);
    ...
    static boolean containsOnlyValidXChars(
            Phonenumber.PhoneNumber number, String candidate, PhoneNumberUtil util) {
